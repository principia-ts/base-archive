...
export const memento: <R, E, A>(fa: Sync<R, E, A>) => Sync<R, never, E.Either<E, A>> = Z.memento

export const absolve: <R, E, E1, A>(fa: Sync<R, E1, E.Either<E, A>>) => Sync<R, E | E1, A> = Z.absolve
