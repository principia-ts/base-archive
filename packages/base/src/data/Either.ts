 ...
 * @since 1.0.0
 */
export function product_<E, A, G, B>(
  fa: Either<E, A>,
  fb: Either<G, B>
 ...
 * @since 1.0.0
 */
export function map2_<E, A, G, B, C>(
  fa: Either<E, A>,
  fb: Either<G, B>,
  f: (a: A, b: B) => C
): Either<E | G, C> {
 ...
 * @since 1.0.0
 */
export function flatMap_<E, A, G, B>(
  fa: Either<E, A>,
  f: (a: A) => Either<G, B>
): Either<E | G, B> {
 ...
 * @since 1.0.0
 */
export function getApplicativeValidation<E>(
  S: P.Semigroup<E>
