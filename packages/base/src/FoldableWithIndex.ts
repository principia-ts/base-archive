...
export function getFoldableWithIndexComposition<F, G>(
  ...
  const foldLeftWithIndex_: FoldLeftWithIndexFnComposition_<HKT.UHKT<F>, HKT.UHKT<G>> = <
    KF,
    KG,
    A,
    B
  ...
  const foldRightWithIndex_: FoldRightWithIndexFnComposition_<HKT.UHKT<F>, HKT.UHKT<G>> = <
    KF,
    KG,
    A,
    B
...
export interface FoldLeftWithIndexFnComposition<
  F extends HKT.URIS,
  G extends HKT.URIS,
  CF = HKT.Auto,
  CG = HKT.Auto
...
export interface FoldLeftWithIndexFnComposition_<
  F extends HKT.URIS,
  G extends HKT.URIS,
  CF = HKT.Auto,
  CG = HKT.Auto
...
export interface FoldRightWithIndexFnComposition<
  F extends HKT.URIS,
  G extends HKT.URIS,
  CF = HKT.Auto,
  CG = HKT.Auto
