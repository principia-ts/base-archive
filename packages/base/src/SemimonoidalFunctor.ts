...
export function aplF_<F extends HKT.URIS, C = HKT.Auto>(A: SemimonoidalFunctor<F, C>): ApLeftFn_<F, C> {
  return (left, right) => A.crossWith_(left, right, (l, _) => l)
}

export function aplF<F extends HKT.URIS, C = HKT.Auto>(A: SemimonoidalFunctor<F, C>): ApLeftFn<F, C> {
...
export function aprF_<F extends HKT.URIS, C = HKT.Auto>(A: SemimonoidalFunctor<F, C>): ApRightFn_<F, C> {
  return (left, right) => A.crossWith_(left, right, (_, r) => r)
}

export function aprF<F extends HKT.URIS, C = HKT.Auto>(A: SemimonoidalFunctor<F, C>): ApRightFn<F, C> {
