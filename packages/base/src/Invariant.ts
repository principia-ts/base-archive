...
export interface InvariantComposition<
  F extends HKT.URIS,
  G extends HKT.URIS,
  CF = HKT.Auto,
  CG = HKT.Auto
...
export function getInvariantComposition<
  F extends HKT.URIS,
  G extends HKT.URIS,
  CF = HKT.Auto,
  CG = HKT.Auto
>(F: Invariant<F, CF>, G: Invariant<G, CG>): InvariantComposition<F, G, CF, CG>;
export function getInvariantComposition<F, G>(
  F: Invariant<HKT.UHKT<F>>,
  G: Invariant<HKT.UHKT<G>>
) {
...
export interface IMapFnComposition<
  F extends HKT.URIS,
  G extends HKT.URIS,
  CF = HKT.Auto,
  CG = HKT.Auto
...
export interface IMapFnComposition_<
  F extends HKT.URIS,
  G extends HKT.URIS,
  CF = HKT.Auto,
  CG = HKT.Auto
