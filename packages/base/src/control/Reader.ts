...
export function product_<R, A, R1, B>(
  fa: Reader<R, A>,
  fb: Reader<R1, B>
...
export function flatMap_<R, A, R1, B>(
  ma: Reader<R, A>,
  f: (a: A) => Reader<R1, B>
): Reader<R & R1, B> {
  return (r) => f(ma(r))(r);
...
export function flatMap<A, R1, B>(
  f: (a: A) => Reader<R1, B>
