...
): Managed<R, E, readonly [T.IO<any>, A]> =>
...
export const withEarlyReleaseExit = (exit: Ex.Exit<any, any>) => <R, E, A>(
   ma: Managed<R, E, A>
): Managed<R, E, readonly [T.IO<any>, A]> => withEarlyReleaseExit_(ma, exit);

export const withEarlyRelease = <R, E, A>(ma: Managed<R, E, A>): Managed<R, E, readonly [T.IO<any>, A]> =>
