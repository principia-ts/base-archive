...
export const takeBetween_ = <RA, RB, EA, EB, A, B>(
   ...
   min: number,
   max: number
): T.Task<RB, EB, readonly B[]> => takeBetween(min, max)(self);
 ...
 * specified effectual functions.
 */
export const bimapM = <A, B, C, RC, EC, RD, ED, D>(f: (c: C) => T.Task<RC, EC, A>, g: (b: B) => T.Task<RD, ED, D>) => <
   RA,
   RB,
   EA,
   EB
>(
   self: XQueue<RA, RB, EA, EB, A, B>
): XQueue<RC & RA, RD & RB, EC | EA, ED | EB, C, D> => bimapM_(self, f, g);
 ...
 */
export const contramapM = <C, RA2, EA2, A>(f: (c: C) => T.Task<RA2, EA2, A>) => <RA, RB, EA, EB, B>(
   self: XQueue<RA, RB, EA, EB, A, B>
 ...
 */
export const filterInputM = <A, A1 extends A, R2, E2>(f: (_: A1) => T.Task<R2, E2, boolean>) => <RA, RB, EA, EB, B>(
   self: XQueue<RA, RB, EA, EB, A, B>
 ...
 */
export const mapM = <B, R2, E2, C>(f: (b: B) => T.Task<R2, E2, C>) => <RA, RB, EA, EB, A>(
   self: XQueue<RA, RB, EA, EB, A, B>
