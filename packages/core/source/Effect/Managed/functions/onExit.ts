 ...
 */
export const _onExit = <R, E, A, R1>(self: Managed<R, E, A>, cleanup: (exit: Exit<E, A>) => T.Effect<R1, never, any>) =>
   managed<R & R1, E, A>(
 ...
 * the existing finalizers.
 */
export const onExit = <E, A, R1>(cleanup: (exit: Exit<E, A>) => T.Effect<R1, never, any>) => <R>(
   self: Managed<R, E, A>
