...
export interface UC_ReduceRightWithIndexF<F extends HKT.URIS, C = HKT.Auto> {
...
export interface ReduceRightWithIndexFComposition<
   F extends HKT.URIS,
   G extends HKT.URIS,
   CF = HKT.Auto,
   CG = HKT.Auto
...
export interface UC_ReduceRightWithIndexFComposition<
   F extends HKT.URIS,
   G extends HKT.URIS,
   CF = HKT.Auto,
   CG = HKT.Auto
