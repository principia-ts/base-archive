...
export interface BothF<F extends HKT.URIS, C = HKT.Auto> {
   <N2 extends string, K1, Q1, W1, X1, I1, S1, R1, E1, B>(
      fb: HKT.Kind<F, C, N2, K1, Q1, W1, X1, I1, S1, R1, E1, B>
...
export interface BothFComposition<
   F extends HKT.URIS,
   G extends HKT.URIS,
   CF = HKT.Auto,
   CG = HKT.Auto
...
export interface UC_BothFComposition<
   F extends HKT.URIS,
   G extends HKT.URIS,
   CF = HKT.Auto,
   CG = HKT.Auto
