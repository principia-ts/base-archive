...
export interface BothF<F extends HKT.URIS, C = HKT.Auto> {
   <N2 extends string, K1, Q1, W1, X1, I1, S1, R1, E1, B>(fb: HKT.Kind<F, C, N2, K1, Q1, W1, X1, I1, S1, R1, E1, B>): <
      N extends string,
      K,
      Q,
      W,
...
export interface BothFComposition<F extends HKT.URIS, G extends HKT.URIS, CF = HKT.Auto, CG = HKT.Auto> {
   <
      NF1 extends string,
      KF1,
      QF1,
...
export interface UC_BothFComposition<F extends HKT.URIS, G extends HKT.URIS, CF = HKT.Auto, CG = HKT.Auto> {
   <
      NF extends string,
      KF,
      QF,
