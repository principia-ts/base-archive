...
export interface PartitionF<F extends HKT.URIS, C = HKT.Auto> {
   ...
   <A>(predicate: Predicate<A>): <N extends string, K, Q, W, X, I, S, R, E>(
      fa: HKT.Kind<F, C, N, K, Q, W, X, I, S, R, E, A>
   ) => Separated<HKT.Kind<F, C, string, K, Q, W, X, I, S, R, E, A>, HKT.Kind<F, C, string, K, Q, W, X, I, S, R, E, A>>;
}

export interface UC_PartitionF<F extends HKT.URIS, C = HKT.Auto> {
