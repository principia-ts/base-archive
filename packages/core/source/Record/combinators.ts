...
export const keys = <N extends string>(r: ReadonlyRecord<N, unknown>): ReadonlyArray<N> =>
...
export const collect = <N extends string, A, B>(f: (k: N, a: A) => B) => (
...
export const insertAt = <K extends string, A>(k: K, a: A) => <N extends string>(
   r: ReadonlyRecord<N, A>
) => _insertAt(r, k, a);
...
export const deleteAt = <N extends string, K extends N>(k: K) => <A>(r: ReadonlyRecord<N, A>) =>
   _deleteAt(r, k);
...
export const updateAt = <N extends string, A>(k: N, a: A) => (r: ReadonlyRecord<N, A>) =>
   _updateAt(r, k, a);
...
export const modifyAt = <N extends string, A>(k: N, f: (a: A) => A) => (r: ReadonlyRecord<N, A>) =>
   _modifyAt(r, k, f);
...
export const pop = <N extends string, K extends N>(k: K) => <A>(r: ReadonlyRecord<N, A>) =>
   _pop(r, k);
