...
export function zipWithPar<A, R1, E1, A1, B>(
  mb: T.AIO<R1, E1, A1>,
  f: (a: A, b: A1) => B
): <R, E>(ma: T.AIO<R, E, A>) => T.AIO<R & R1, E1 | E, B> {
...
export function apPar<R, E, A>(
  fa: T.AIO<R, E, A>
): <Q, D, B>(fab: T.AIO<Q, D, (a: A) => B>) => T.AIO<Q & R, E | D, B> {
...
export function apFirstPar<R1, E1, B>(
  fb: T.AIO<R1, E1, B>
): <R, E, A>(fa: T.AIO<R, E, A>) => T.AIO<R & R1, E1 | E, A> {
...
export function apSecondPar<R1, E1, B>(
  fb: T.AIO<R1, E1, B>
): <R, E, A>(fa: T.AIO<R, E, A>) => T.AIO<R & R1, E1 | E, B> {
