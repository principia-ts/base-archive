 ...
 * will be lost.
 */
export function validate_<A, R, E, B>(as: Iterable<A>, f: (a: A) => AIO<R, E, B>) {
  return absolve(
    map_(
...
export function validate<A, R, E, B>(
  f: (a: A) => AIO<R, E, B>
): (as: Iterable<A>) => AIO<R, NonEmptyArray<E>, B[]> {
 ...
 * will be lost.
 */
export function validatePar_<A, R, E, B>(as: Iterable<A>, f: (a: A) => AIO<R, E, B>) {
  return absolve(
    map_(
...
export function validateParN_(n: number) {
  return <A, R, E, B>(as: Iterable<A>, f: (a: A) => AIO<R, E, B>) =>
    absolve(
      map_(
...
export function validateParN(
  ...
  f: (a: A) => AIO<R, E, B>
) => (as: Iterable<A>) => AIO<R, NonEmptyArray<E>, readonly B[]> {
...
export function validateExec_<R, E, A, B>(
  ...
  as: Iterable<A>,
  f: (a: A) => AIO<R, E, B>
): AIO<R, NonEmptyArray<E>, ReadonlyArray<B>> {
  return absolve(
    map_(
...
export function validateExec(
  ...
  f: (a: A) => AIO<R, E, B>
) => (as: Iterable<A>) => AIO<R, NonEmptyArray<E>, ReadonlyArray<B>> {
