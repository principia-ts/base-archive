...
import { forkDaemon } from "../../AIO/combinators/core-scope";
...
/**
 * ```haskell
 * interrupt :: Fiber e a -> AIO _ _ (Exit e a)
 * ```
 *
...
/**
 * ```haskell
 * interruptAllAs_ :: (Iterable (Fiber Any Any), FiberId) -> AIO _ _ ()
 * ```
 *
...
/**
 * ```haskell
 * interruptAllAs :: FiberId -> Iterable (Fiber Any Any) -> AIO _ _ ()
 * ```
 *
 * Interrupts all fibers as by the specified fiber, awaiting their interruption.
 */
...
/**
 * ```haskell
 * interruptFork :: Fiber e a -> AIO _ _ ()
 * ```
 *
