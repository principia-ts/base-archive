...
export abstract class XQueue<RA, RB, EA, EB, A, B> {
   ...
   */
  abstract readonly offer: (a: A) => AIO<RA, EA, boolean>;
  /**
   ...
   *
   */
  abstract readonly offerAll: (as: Iterable<A>) => AIO<RA, EA, boolean>;
  /**
   ...
   */
  abstract readonly take: AIO<RB, EB, B>;
  /**
   * Removes all the values in the queue and returns the list of the values. If the queue
   * is empty returns empty list.
   */
  abstract readonly takeAll: AIO<RB, EB, readonly B[]>;
  /**
   * Takes up to max number of values in the queue.
   */
  abstract readonly takeUpTo: (n: number) => AIO<RB, EB, readonly B[]>;
}
