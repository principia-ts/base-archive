...
export const orElse_: <E, A, M>(ma: EIO<E, A>, onLeft: (e: E) => EIO<M, A>) => EIO<M, A> =
  X.orElse_;
...
export function filterOrElse_<E, A, E1>(
  ma: EIO<E, A>,
...
export function chainEitherK_<E, A, E1, B>(
  ma: EIO<E, A>,
  f: (a: A) => Either<E1, B>
): EIO<E | E1, B> {
...
export function chainEitherK<A, E1, B>(
  f: (a: A) => Either<E1, B>
): <E>(ma: EIO<E, A>) => EIO<E1 | E, B> {
