 ...
 */
export function run<E, A>(_: I.IO<DefaultEnv, E, A>, cb?: Callback<E, A>) {
 ...
 * Runs effect until completion, calling cb with the eventual exit state
 */
export function runAsap<E, A>(_: I.IO<DefaultEnv, E, A>, cb?: Callback<E, A>) {
  const context = fiberExecutor<E, A>();
 ...
 * in case of error.
 */
export function runPromiseExit<E, A>(_: I.IO<DefaultEnv, E, A>): Promise<Exit<E, A>> {
  const context = fiberExecutor<E, A>();
 ...
 */
export function runCancel<E, A>(_: I.IO<DefaultEnv, E, A>, cb?: Callback<E, A>): AsyncCancel<E, A> {
  const context = fiberExecutor<E, A>();
 ...
 * in case of error.
 */
export function runPromise<E, A>(_: I.IO<DefaultEnv, E, A>): Promise<A> {
  const context = fiberExecutor<E, A>();
