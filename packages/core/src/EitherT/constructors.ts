...
export const left = <F extends HKT.URIS, C = HKT.Auto>(M: P.Monad<F, C>) => <E>(l: E) => pureF(M)(E.left(l));

export const right = <F extends HKT.URIS, C = HKT.Auto>(M: P.Monad<F, C>) => <A>(r: A) => pureF(M)(E.right(r));
