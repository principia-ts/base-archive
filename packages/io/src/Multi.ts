...
export function apFirst_<W, S1, S2, R, E, A, W1, S3, Q, D, B>(
  fa: Multi<W, S1, S2, R, E, A>,
  fb: Multi<W1, S2, S3, Q, D, B>
...
export function apFirst<W1, S2, S3, Q, D, B>(
  fb: Multi<W1, S2, S3, Q, D, B>
): <W, S1, R, E, A>(fa: Multi<W, S1, S2, R, E, A>) => Multi<W | W1, S1, S3, Q & R, D | E, A> {
  return (fa) => apFirst_(fa, fb)
}

export function apSecond_<W, S1, S2, R, E, A, W1, S3, Q, D, B>(
  fa: Multi<W, S1, S2, R, E, A>,
  fb: Multi<W1, S2, S3, Q, D, B>
...
export function apSecond<W1, S2, S3, Q, D, B>(
  fb: Multi<W1, S2, S3, Q, D, B>
