...
export function projectFieldWithEnv<
  T extends R.ReadonlyRecord<any, (e: R) => R.ReadonlyRecord<any, any>>,
  R
>(t: T, env: R) {
...
export function projectWithEnv<
  T extends R.ReadonlyRecord<any, (_: Env) => R.ReadonlyRecord<string, any>>,
  Env
>(
  t: T,
  env: Env
