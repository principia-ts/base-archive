      ...
      return (sourceFile: ts.SourceFile) => {
        ...
        function visitor(node: ts.Node): ts.VisitResult<ts.Node> {
          ...
          if (ts.isCallExpression(node)) {
            ...
            const traceRetTags = new Set([...traceRetTagsMain, ...(traceRetTagsOverload || [])]);

            const traceCallTags = [...traceCallTagsMain, ...(traceCallTagsOverload || [])];
                          ...
                          return factory.createExpressionStatement(
                            factory.createBinaryExpression(
                              factory.createElementAccessExpression(
                                factory.createPropertyAccessExpression(factory.createThis(), id),
                                traceVar
                              ),
            ...
            [
              factory.createIfStatement(
                ...
                factory.createExpressionStatement(
                  factory.createBinaryExpression(
                    factory.createElementAccessExpression(factory.createIdentifier("f"), traceVar),
                    factory.createToken(ts.SyntaxKind.EqualsToken),
                    factory.createBinaryExpression(
                      fileVar,
                      factory.createToken(ts.SyntaxKind.PlusToken),
        ...
        if (tracingOn) {
          ...
          return factory.updateSourceFile(visited, [
            factory.createImportDeclaration(
              ...
              factory.createStringLiteral("@principia/compile/tracing-utils")
            ),
            traceNode,
            fileNode,
            traceFNode,
