...
export function ObjectResponseValue(
  fields: ReadonlyRecord<string, ResponseValue>
): ObjectResponseValue {
  return {
...
export function StreamResponseValue(
  stream: FStream<GraphQlException, ResponseValue>
): StreamResponseValue {
  return {
