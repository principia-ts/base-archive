...
export const fail = <E, I>(
   e: E,
   leftover: ReadonlyArray<I>
): T.IO<[E.Either<E, never>, ReadonlyArray<I>], never> => T.fail([E.left(e), leftover]);

export const halt = <E>(c: Cause<E>): T.IO<[E.Either<E, never>, ReadonlyArray<never>], never> =>
   T._first(T.halt(c), (e) => [E.left(e), []]);
