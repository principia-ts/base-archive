...
export interface ReduceRightFnComposition<F extends HKT.URIS, G extends HKT.URIS, CF = HKT.Auto, CG = HKT.Auto> {
   <A, B>(b: B, f: (a: A, b: B) => B): <
      FN extends string,
      FK,
      FQ,
...
export interface ReduceRightFnComposition_<F extends HKT.URIS, G extends HKT.URIS, CF = HKT.Auto, CG = HKT.Auto> {
